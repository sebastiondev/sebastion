        ...
        {artifacts.map((artifact, i) => (
          <li key={i}>
            <a
              ...
              className="group flex items-start gap-3 rounded-lg px-3 py-2.5 -mx-3 transition-colors hover:bg-[var(--color-brand)]/5"
            >
              <span className="flex-shrink-0 text-sm mt-0.5">
                {typeIcons[artifact.type] || "📎"}
              </span>
              <div className="flex-1 min-w-0">
                <span className="text-[0.875rem] font-medium text-[var(--color-text-primary)] group-hover:text-[var(--color-brand)] transition-colors">
              ...
              <span className="flex-shrink-0 text-[var(--color-text-tertiary)] group-hover:text-[var(--color-brand)] transition-colors text-sm mt-1">
                ↗
              </span>
            </a>
          </li>
